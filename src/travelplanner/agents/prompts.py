...
class PromptTemplateFromScratch(object):
    ...
    def __call__(self, **kwargs):
        for variable in kwargs:
            if variable not in self.input_variables:
                raise Exception(f"At least one of the variables from {kwargs} doesn't exist in input variables")
